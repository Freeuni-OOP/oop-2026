...
insert into students (student_id, id_number, first_name, last_name)
...
where (s.first_name = 'temur' and c.course_credit = 7)
   or (s.first_name = 'temur' and c.course_credit = 4);
